...
const importMap = {
  '@tanstack/react-query': async () => {
    let pkg = await import(
      '__mf__virtual/host_app__prebuild___mf_0_tanstack_mf_1_react_mf_2_query__prebuild__.js'
    );
    return pkg;
  },
  react: async () => {
  ...
  'react-router-dom': async () => {
    let pkg = await import(
      '__mf__virtual/host_app__prebuild__react_mf_2_router_mf_2_dom__prebuild__.js'
    );
    return pkg;
  },
};
